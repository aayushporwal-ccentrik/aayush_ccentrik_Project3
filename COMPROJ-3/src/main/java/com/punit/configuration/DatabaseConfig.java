 ...
 * 
 * Logger cloudFoundryDataSourceConfigLogger =
 * LoggerFactory.getLogger(this.getClass());
 * 
 * // ✅ FIX: Use default empty string if property not found
 * 
 * @Value("${vcap.services.sql.credentials.username:}") private String username;
 * 
 * @Value("${vcap.services.sql.credentials.password:}") private String password;
 * 
 * @Value("${vcap.services.sql.credentials.hostname:}") private String hostname;
 * 
 * @Value("${vcap.services.sql.credentials.port:}") private String port;
 * 
 * @Value("${vcap.services.sql.credentials.dbname:}") private String dbname;
 * 
 * @Bean public DataSource dataSource() {
 * cloudFoundryDataSourceConfigLogger.info(
 * "========================================");
 * cloudFoundryDataSourceConfigLogger.
 * info("🔍 DATABASE CONFIG FROM VCAP_SERVICES");
 * cloudFoundryDataSourceConfigLogger.info(
 * "========================================");
 ...
 * "========================================");
 * 
 * // ✅ CRITICAL: Check if credentials are actually loaded if (hostname == null
 * || hostname.trim().isEmpty()) { String errorMsg =
 * "❌ ERROR: VCAP_SERVICES not loaded!\n" +
 ...
 * cloudFoundryDataSourceConfigLogger.error(errorMsg); throw new
 * RuntimeException(errorMsg); }
 * 
 * DriverManagerDataSource dataSource = new DriverManagerDataSource();
 * dataSource.setDriverClassName("org.postgresql.Driver");
 * 
 * // ✅ Build JDBC URL with SSL mode String url = "jdbc:postgresql://" +
 * hostname + ":" + port + "/" + dbname + "?sslmode=require";
 ...
 * dataSource) { LocalContainerEntityManagerFactoryBean em = new
 ...
 * 
 * em.setJpaProperties(props); return em; }
 * 
